...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    sections: { Monitoring: 'fact_check', Synchronization: 'sync', Budget: 'account_balance_wallet' },
    items: [
      ...
      { label: 'Budget Dashboard', path: 'budget-dashboard', icon: 'dashboard', perms: VIEW_CONTRACTS, section: 'Budget' },
      { label: 'Budget Preparation', path: 'budget-preparation', icon: 'edit_note', perms: ['Prepare/Edit Draft Budget', 'Approve Budget'], section: 'Budget' },
      { label: 'Budget Breakdown', path: 'budget-breakdown', icon: 'pie_chart', perms: VIEW_CONTRACTS, section: 'Budget' },
      { label: 'Cost & Petty Cash', path: 'forecast', icon: 'trending_up', perms: VIEW_CONTRACTS, section: 'Budget' },
      { label: 'Project Requests', path: 'projects', icon: 'rocket_launch', perms: ['Submit Project Requests', 'Approve Projects', 'View Contracts'], section: 'Budget' },
    ],
  },
  {
