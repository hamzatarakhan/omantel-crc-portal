...
@Component({
  ...
  template: `
    <header class="h-16 bg-white border-b border-surface-border flex items-center gap-3 px-4 sm:px-5 shrink-0">
      ...
      <button class="w-9 h-9 rounded-lg flex items-center justify-center text-ink-500 hover:bg-surface-subtle sm:hidden shrink-0">
